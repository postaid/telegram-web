...
const TEMPLATE = '<svg xmlns="http://www.w3.org/2000/svg" class="IconDropdownArrow" width="24" height="24" viewBox="0 0 24 24">\n' +
  ...
  '    </g>\n' +
  '</svg>';
class IconDropdownArrow extends Component {
  constructor () {
    super();
    this.render();
  }
  render () {
    this.el = TemplateGenerator.generate(TEMPLATE, 'IconDropdownArrow');
    this.path_ = this.el.getElementsByTagName('path')[0];
  }
  ...
  setColor (color) {
    this.path_.setAttribute('stroke', color);
  }
}
